...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Thor Borchik = new Thor(265,32,"Barbi" );
        Golem stone = new Golem(290, 10, "golem");
        Teacher alina = new Teacher(230, 5, "Gvinevra");
        Hero[] heroes = {warrior, doc, magic, berserk, assistant, Borchik, stone, alina};
